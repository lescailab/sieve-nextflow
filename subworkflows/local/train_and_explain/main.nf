...
workflow TRAIN_AND_EXPLAIN {
    ...
    //
    // Null baseline: create null data, train, explain, compare attributions, sex-fix compare
    //
    ...
    if (targetNull) {
        ...
        // Prepare channels for epistasis subworkflow
    ...
    published_null_comparison_sex_fixed = ch_published_null_comparison_sex_fixed // channel: publish files
